...
class User(AbstractUser):
    pfp = models.ImageField(upload_to="network/", default="network/profile.jpg",null=True)
    header = models.ImageField(upload_to="network/", default="network/header.jpg",null=True)
    def serialize(self):
        return {
            "id": self.id,
